...
***** TODO this does not work in an org-indent-mode buffer
See [[*indent by default][indent by default]]
**** Indent guides
...
I started writing this file without this mode active, leading to significant diff in lines that were not touched (but only moved in heading depth)
