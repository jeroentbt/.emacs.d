...
#+BEGIN_SRC emacs-lisp :tangle yes
    (req-package company
      :require (yasnippet company-quickhelp)
...
**** yasnippet
     ...
     This blob of elisp (found [[http://emacs.stackexchange.com/questions/10431/get-company-to-show-suggestions-for-yasnippet-names][here]]) however will make sure yasnippet snippets are always offered as a posibility (no matter what backend is currently in use).
...
**** File config
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq org-agenda-files '("~/Documents/org" "~/.emacs.d"))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq org-capture-templates
        (quote (("t" "todo" entry (concat org-directory "/refile.org")
                 "* TODO %?\n%U\n%a\n" :clock-in t :clock-resume t)
                ("r" "respond" entry (concat org-directory "/refile.org")
                 "* NEXT Respond to %:from on %:subject\nSCHEDULED: %t\n%U\n%a\n" :clock-in t :clock-resume t :immediate-finish t)
                ("n" "note" entry (concat org-directory "/refile.org")
                 "* %? :NOTE:\n%U\n%a\n" :clock-in t :clock-resume t)
                ("a" "interesting app" entry (concat org-directory "/interesting_apps.org")
                 "* %? \n" :clock-in t :clock-resume t)
                ("j" "Journal" entry (concat org-directory "/diary.org")
                 "* %?\n%U\n" :clock-in t :clock-resume t)
                ("w" "org-protocol" entry (concat org-directory "/refile.org")
                 "* TODO Review %c\n%U\n" :immediate-finish t)
                ("m" "Meeting" entry (concat org-directory "/refile.org")
                 "* MEETING with %? :MEETING:\n%U" :clock-in t :clock-resume t)
                ("p" "Phone call" entry (concat org-directory "/refile.org")
                 "* PHONE %? :PHONE:\n%U" :clock-in t :clock-resume t)
                ("h" "Habit" entry (concat org-directory "/refile.org")
