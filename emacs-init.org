...
*** TODO Remove Cask and Pallet as dependencies
...
adds the =:require= keyword which allows you to define (and resolve through
installation of those) dependencies between related packages.
#+END_QUOTE
...
****** TODO Prefixes that used to trigger guide-key
