...
**** File config
#+BEGIN_SRC emacs-lisp :tangle yes
  (setq org-agenda-files '("~/Documents/org" "~/Documents/org/clients" "~/.emacs.d"))
  ...
  (setq org-capture-templates
        (quote (("t" "todo" entry (file "~/Documents/org/refile.org")
                ...
                ("a" "interesting app" entry (file "~/Documents/org/interesting_apps.org")
                 "* %? \n" :clock-in t :clock-resume t)
                ("j" "Journal" entry (file "~/Documents/org/diary.org")
                 "* %?\n%U\n" :clock-in t :clock-resume t)
...
**** Org capture Quake style
     ...
     using this only for =(yequake-org-capture)= which opens a capture frame on its own
