...
This uses [[https://github.com/raxod502/straight.el#git-backend][raxod502/straight.el]] for package installation by default (see [[file:init.el::setq straight-use-package-by-default t][init.el]])
...
****** title
Hide the =#+title:= keyword and make it BIG
