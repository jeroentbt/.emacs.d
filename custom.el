(custom-set-variables
 ...
 '(package-selected-packages
    '(consult-projectile embark-consult embark consult-dir consult marginalia orderless vertico elfeed-org elfeed ement plz deft magit-annex git-annex ts ht helm-org wfnames helm-core poetry combobulate tree-sitter-langs tree-sitter git-auto-commit-mode blamer diredfl dired-subtree dired-filter dired-collapse all-the-icons-dired multiple-cursors discover which-key popwin olivetti php-mode org-roam-ui org-roam org-agenda-property org-download org-superstar org-appear keycast-mode keycast mpv helm-org-ql org-ql ov org-linker-edna org-linker org-edna all-the-icons neotree mu4e-column-faces org-super-agenda hcl-mode tron-legacy-theme org-journal python-docstring tdd git-gutter rainbow-delimiters org-sticky-header helm-org-rifle company iedit company-fuzzy helm-company rainbow-identifiers clues-theme noctilux-theme monokai-theme spacemacs-theme solarized-theme yequake org-drill ace-mc plantuml-mode ace-window zeal-at-point async company-quickhelp darkroom diminish esqlite flx helm helm-ag helm-projectile helm-swoop ido-completing-read+ js2-refactor yasnippet nimbus-theme window-margin ox-hugo go-mode go-projectile ansi yafolding helm-flx markdown-mode+ company-tern helm-orgcard challenger-deep-theme kotlin-mode el-get html-to-markdown org-plus-contrib jekyll-modes ob-restclient restclient yaml-mode doom-themes org-mime znc zenburn-theme web-mode undo-tree tern spaces spacegray-theme smooth-scrolling smex smartparens smart-mode-line skewer-mode req-package rainbow-mode puppet-mode projectile pdf-tools paradox pallet ox-reveal org-bullets magit json-mode jedi ix interleave indent-guide ido-vertical-mode ido-ubiquitous ido-at-point hungry-delete highlight-symbol heroku-theme git-timemachine git-messenger gist flycheck flx-ido expand-region erc-hl-nicks emmet-mode elpy editorconfig discover-js2-refactor direx dash-at-point color-theme-sanityinc-tomorrow color-theme-sanityinc-solarized buffer-move browse-kill-ring anti-zenburn-theme ample-theme ag adaptive-wrap ace-jump-mode))
